...
public class PickUpController {
    ...
    @FXML
    private ImageView pickUpMapImageView;
    ...
    public void initialize() {
        ...
        pickuplocationTextfield.setOnKeyReleased(event -> updateImage());
    }

    public void updateImage() {
        String location = pickuplocationTextfield.getText().trim().toLowerCase();
        String imagePath = "";
        ...
        try {
            ...
            pickUpMapImageView.setImage(image);
        } catch (Exception e) {
    ...
    @FXML   
    private void pickupproceedHandler(ActionEvent event) {
        ...
        try {
            ...
            LocationController locationController = loader.getController();
             ...
             // Pass the selected location to the next page
            String selectedLocation = pickuplocationTextfield.getText().trim();
            locationController.setPickupLocation(selectedLocation);
